...
const mockCall = (func: string, params: any[] | null | undefined, callback: (response: any) => void) => {
  ...
  switch (func) {
    case BuilderController.getForm:
      cb = callback({
        result: {
          Id: 1,
          Name: "Clarity Form",
          cforms__Title__c: "Clarity Form",
          cforms__Description__c: "First Form",
          cforms__Connected_Object__c: "Account",
          cforms__Status__c: "Draft"
        },
    ...
    case BuilderController.getQuestions:
      ...
      break;
    case BuilderController.getSObjectsAvailable:
      cb = callback({
        result: [
          "Account",
          "Case",
...
// const mockCall = (func: string, params: any[]) => {
//   const date = new Date();
