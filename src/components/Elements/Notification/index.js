...
const StatusMessage = {
  error: {
    ...
    saveConnections: [
      "Error",
      "Something went wrong on while saving connections, please report and refresh this error.",
    ],
    updateStatus: [
      "Error",
      "Something went wrong on while saving the status, please report and refresh this error.",
    ],
    updateForm: ["Error", "Form setting errors."],
    FormPublished: [
      "Error",
      "Changes to form will not be saved because form has been published.",
    ],
  },
  success: {
