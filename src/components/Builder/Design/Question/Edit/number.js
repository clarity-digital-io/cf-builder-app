            ...
            <View className="row">
                <View className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <Box padding='0'>
                        ...
                        <InputNumber min={0} max={activeQuestion.forms__Max_Range__c - 1} onChange={updateMin} value={ activeQuestion.forms__Min_Range__c } />
                ...
                <View className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <Box padding='0'>
                        ...
                        <InputNumber min={activeQuestion.forms__Min_Range__c} onChange={updateMax} value={ activeQuestion.forms__Max_Range__c } />
                ...
                <View className="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                    <Box padding='0'>
                        ...
                        <InputNumber onChange={updateStep} value={ activeQuestion.forms__Step__c } />
