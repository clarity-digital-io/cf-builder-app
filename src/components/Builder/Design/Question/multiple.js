                        ...
                        <ViewStyle>
                            ...
                            <div className="slds-form-element">
                                <label className="slds-checkbox_toggle slds-grid">
                                    ...
                                    <input value={activeQuestion.Required__c} onClick={(e) => updateRequiredStatus(e)} type="checkbox" name="checkbox-toggle-14" value="checkbox-toggle-14" aria-describedby="checkbox-toggle-14" />
