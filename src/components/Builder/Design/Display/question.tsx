  ...
  return (
    <QuestionStyle key={"Question"}>
      <Options active={question.Id != null && question.Id == activeQuestion.Id}>
        <div>
          <li onClick={() => edit("EDIT")}>
            <Icon label="Edit" type="edit" background="#1589ee" />
          </li>

          <li onClick={() => edit("LOGIC")}>
            <Icon label="Logic" type="hierarchy" background="#16325c" />
          </li>
          ...
          <li onClick={() => setQuestionToDelete(question.Id)}>
            <Icon label="Delete" type="delete" background="#d4504c" />
          </li>
        </div>
      </Options>
