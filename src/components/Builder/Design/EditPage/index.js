...
export const EditPageState = () => {
    ...
    const { form, setForm, setError } = useContext(BuilderContext);
		...
		const [activePageInfo, setActivePageInfo] = useState(getCorrectPage(form.forms__Multi_Page_Info__c, activePage))
                ...
                <Box padding='0'>
                    ...
                    <ViewStyle space border>
                        ...
                        <h1>Validate By Page</h1>
												<p>Continue button is disabled until all fields meet validation requirements.</p>
